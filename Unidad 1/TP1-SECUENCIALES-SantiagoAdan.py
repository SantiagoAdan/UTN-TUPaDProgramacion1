...
if numero1 != 0:
    ...
    if numero2 != 0:
        print(
            f"Suma = {numero1 + numero2} | "
            f"Resta = {numero1 - numero2} | "
            f"Multiplicación = {numero1 * numero2} | "
            f"División = {numero1 / numero2}"
        )
    else:
        print("No puede ingresar el número 0 para esta operación")
else:
    print("No puede ingresar el número 0 para esta operación")
